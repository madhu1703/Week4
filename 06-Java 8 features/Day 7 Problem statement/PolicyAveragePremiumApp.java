...
class InsPolicy {
    ...
    public InsPolicy(String policyNumber, String holderName, double premiumAmount) {
...
public class PolicyAveragePremiumApp {
    public static void main(String[] args) {
        ...
        OptionalDouble averagePremium = policies.stream()
                ...
                .average();
        if (averagePremium.isPresent()) {
            System.out.println("Average Premium Amount: $" + averagePremium.getAsDouble());
        } else {
